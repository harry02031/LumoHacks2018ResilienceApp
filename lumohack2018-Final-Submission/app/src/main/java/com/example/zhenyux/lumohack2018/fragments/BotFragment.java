...
import com.example.zhenyux.lumohack2018.botActivity;
...
public class BotFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        responseText =  (EditText) view.findViewById(R.id.botActivityInputText);
        sendbtn= (Button) view.findViewById(R.id.botActivitySendBtn);
        messageListView = (ListView) view.findViewById(R.id.botActivityMessageList);
    ...
    public void showListView(){
        ...
        BotFragment.myListAdapter adapter = new BotFragment.myListAdapter(context, messageList);
